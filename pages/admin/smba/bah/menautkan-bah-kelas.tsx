...
const MenautkanBahKelas = () => {
    ...
    const sortedRecords = useMemo(() => sortBy(dataMenautkanBahKelas, "namaBuku"), []);
    ...
    useEffect(() => {
        ...
        setRecords(dataMenautkanBahKelas.slice(from, to));
    }, [page, pageSize]);
    useEffect(() => {
        const data = sortBy(dataMenautkanBahKelas, sortStatus.columnAccessor);
        ...
        <>
            <div className="flex flex-wrap items-end gap-x-4">
                <div className="mb-4 grid w-2/3 grid-cols-2 gap-x-6 gap-y-2">
                    ...
                    <Selects label="Kelas" data={optionsKurikulum} withAsterisk required />
                    ...
                    <Selects label="Semester" data={optionsKelompokUjian} withAsterisk required />
                </div>

                <div>
                    <Button className="bg-info">Lihat</Button>
                    <Button className="bg-success" onClick={handleTambahBuku}>
                        Tambah Pasangkan Bah Kelas
                    </Button>
                </div>
            </div>
            <Box sx={{ height: records.length > 10 ? 750 : "auto" }} className="mt-4">
                <DataTable
                    ...
                    columns={[
                        {
                            ...
                            sortable: true,
                            width: 70,
                            render: (number) => dataMenautkanBahKelas.indexOf(number) + 1,
                        },
                        { accessor: "namaBuku", title: "Kode BAH", sortable: true },
                        { accessor: "tingkatKelas", title: "Kurikulum ", sortable: true },
                        { accessor: "semester", title: "Jenis Layanan", sortable: true },
                        { accessor: "kurikulum", title: "Jumlah Pertemuan", sortable: true },
                    ]}
                    rowContextMenu={{
                        items: (record) => [
                            {
                    ...
                    totalRecords={dataMenautkanBahKelas.length}
            ...
            {/* Form Tambah Buku */}
            <DialogModal heightFit={true} open={openTambahBuku} handler={handleTambahBuku} size="lg" title="Form Tambah Buku">
                ...
                <div>
                    <div className="mb-6 flex gap-4">
                        <div className="grid w-full gap-2">
                            ...
                            <p>Tingkat Kelas: 12 SMA IPA</p>
                        </div>
                        <div className="grid w-full gap-2">
                            <p>Kurikulum: Kurikulum Nasional</p>
                            <p>Pelajaran: BAHASA INDONESIA</p>
                        </div>
                        <div className="grid w-full gap-2">
                            <p>Jenis Layanan: REGULER NON SD</p>
                            <p>Jumlah Pertemuan: 2</p>
                        </div>
                    </div>
                    <div className="grid gap-4">
                        <h2 className="text-center">Pertemuan / Bab</h2>
                        <div className="grid gap-3">
                            <h3>Pertemuan 0</h3>
                            <ul className="grid gap-2">
                                <li>00.01 Paragraf1</li>
                                <li>00.02 Paragraf2</li>
                                <li>00.03 Paragraf3</li>
                            </ul>
                        </div>
                        <div className="grid gap-3">
                            <h3>Pertemuan 1</h3>
