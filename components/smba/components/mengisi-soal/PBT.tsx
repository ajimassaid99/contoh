                                ...
                                <table>
                                    <thead>
                                        <tr>
                                            ...
                                            {watch("kolom")?.map((item: any, index: any) => (
                                                <th key={index}>{item?.namaKolom}</th>
                                            ))}
                                            <th className="w-24">Action</th>
                                        </tr>
                                    </thead>
                                    ...
                                    <tbody>
                                        {fieldPertanyaan.map((item: any, index: any) => (
                                            <tr key={item?.id}>
                                                ...
                                                {watch("kolom").map((header: any, headerIndex: any) => (
                                                    <td key={header.id}>
                                                        <Controller
                                                            control={control}
                                                            name={`pertanyaan[${index}].opsi`}
                                                            render={({ field: { onChange, value } }) => (
                                                                <Radio
                                                                    checked={value === headerIndex}
                                                                    onChange={(e) => {
                                                                        onChange(e.target.defaultValue);
                                                                        setValue(`pertanyaan[${index}].opsi`, headerIndex);
                                                                    }}
                                                                />
                                                            )}
                                                        />
